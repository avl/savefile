...
pub fn savefile_abi_exportable(
    ...
    let uses = quote_spanned! { defspan =>
        ...
        use savefile::prelude::{ReprC, Schema, SchemaPrimitive, WithSchema, get_schema, Serializer, Serialize, Deserializer, Deserialize, SavefileError, deserialize_slice_as_vec, ReadBytesExt,LittleEndian,AbiMethodArgument, AbiMethod, AbiMethodInfo,AbiTraitDefinition};
