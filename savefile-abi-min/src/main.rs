...
fn main() {
    ...
    let connection = AbiConnection::<dyn AdderInterface>::load_shared_library("/home/anders/savefile/target/debug/libsavefile_abi_min_lib_impl.so").unwrap();
    ...
    println!("Result: {}", res);
    let my_cb = Box::new(MyCallback{value: Arc::new(Mutex::new(32))});
