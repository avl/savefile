...
pub fn test_caller_has_older_version() {
    ...
    let conn1 = unsafe { AbiConnection::<dyn InterfaceV1>::from_boxed_trait_for_test(<dyn InterfaceV2 as AbiExportable>::ABI_ENTRY, iface2 ) }.unwrap();
...
pub fn test_caller_has_newer_version() {
    ...
    let conn1 = unsafe { AbiConnection::<dyn InterfaceV2>::from_boxed_trait_for_test(<dyn InterfaceV1 as AbiExportable>::ABI_ENTRY, iface1 ) }.unwrap();
